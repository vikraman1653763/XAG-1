        ...
        <div className="main-textimonial">
          ...
          <div className="textimonial">
            ...
            <div className="profiles">
              <div className="profile" onClick={() => currentSlide(1)}>
                <img src="/assets/mini.webp" alt="profile 1" />
              </div>
              <div className="profile" onClick={() => currentSlide(2)}>
                <img src="/assets/mini.webp" alt="profile 2" />
              </div>
              <div className="profile" onClick={() => currentSlide(3)}>
                <img src="/assets/mini.webp" alt="profile 3" />
              </div>
              <div className="profile" onClick={() => currentSlide(4)}>
                <img src="/assets/mini.webp" alt="profile 4" />
              </div>
              <div className="profile" onClick={() => currentSlide(5)}>
